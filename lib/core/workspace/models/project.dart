...
class Project {
  ...
  /// Which member of the skin's colour series this project wears.
  ///
  /// The model persists the colour as an ARGB value picked from
  /// [ProjectColors.defaults], so the index is derived rather than stored.
  ...
  int get colorIndex => ProjectColors.defaults.indexOf(color);
  ...
  @override
  String toString() =>
      'Project(id: $id, name: $name, repos: ${repositoryPaths.length})';
}
