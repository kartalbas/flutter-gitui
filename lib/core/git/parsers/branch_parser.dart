...
class BranchParser {
  ...
  static List<GitBranch> parseVerbose(
    String output, {
  ...
  static List<GitBranch> parseRemote(
    String output, {
    List<String>? protectedBranches,
  }) {
    final branches = <GitBranch>[];
  ...
  static List<GitBranch> parseAll(
    String output, {
    List<String>? protectedBranches,
  }) {
    final branches = <GitBranch>[];
  ...
  static GitBranch? _parseBranchLine(
    String line, {
    ...
    try {
      ...
      final isProtected =
          protectedBranches != null && protectedBranches.isNotEmpty
