...
# ============================================================================
# STEP 9: UPDATE WINGET MANIFEST
# ============================================================================

# The manifest pins an installer URL together with the digest of the archive
# behind it, and both are read from the published GitHub release rather than
# from this build: the local archive is a different file under a different name,
# so hashing it would pin a digest that never matches what winget downloads.
# The module checks that the release is published instead of assuming it.
$currentStep++
