...
class BatchOperationResult {
  ...
  @override
  String toString() =>
      'BatchOperationResult(${repository.displayName}: ${success ? 'success' : 'failed'})';
}
...
class BatchOperationsService {
  ...
  BatchOperationsService({this.gitExecutablePath, this.onLog});
  ...
  Future<List<BatchOperationResult>> createBranch(
    ...
    for (final repo in repositories) {
      ...
      onProgress?.call(
        ...
        current,
        total,
        'Creating branch $fullBranchName...',
      );
      ...
      try {
        ...
        // Create branch
        final createResult = await gitService.createBranch(
          fullBranchName,
          checkout: checkout,
        );
        ...
        if (setUpstream) {
          ...
          try {
            ...
            onLog?.call(
              '✓ ${repo.displayName}: Created $fullBranchName: $pushOutput',
            );
          } catch (e) {
            ...
            onLog?.call(
              '⚠ ${repo.displayName}: Created $fullBranchName but push failed: $e',
            );
          }
        } else {
          results.add(
