...
1. **Version Management** - Analyzes commits, determines semantic version
...
6. **Updater Build** - Compiles Dart-based updater executable
7. **Documentation** - Generates README.md (and optional PDF)
...
Build number is calculated as commits since tag + 1.
